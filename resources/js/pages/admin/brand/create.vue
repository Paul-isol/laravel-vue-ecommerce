...
const submit = () => {
    form.post(toUrl(admin.brands.store()));
};
</script>
        ...
        <div class="flex flex-col gap-4 p-4 md:p-8">
            <div class="flex items-center gap-4">
                <Button variant="outline" size="icon" as-child>
                    <Link :href="toUrl(admin.brands.index())">
                ...
                <div class="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Enter the information for the new brand.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardFooter class="justify-between space-x-2">
                             <Button variant="ghost" as-child>
                                <Link :href="toUrl(admin.brands.index())">Cancel</Link>
                            </Button>
                            <Button @click="submit" :disabled="form.processing">Create Brand</Button>
                        </CardFooter>
                    </Card>
                </div>
            </div>
